...
function netivism_form_install_configure_form_alter(&$form, $form_state) {
  ...
  $form['admin_account']['account']['netivism_name'] = array(
    '#type' => 'item', '#title' => st('Username'),
    '#markup' => 'admin'
  );
  $form['admin_account']['account']['netivism_password'] = array(
    '#type' => 'item', '#title' => st('Password'),
    '#markup' => 'admin'
  );
  $form['admin_account']['account']['netivism_informations'] = array(
  ...
  array_unshift($form['#validate'], 'netivism_custom_setting');
}
 ...
 * custom values.
 */
function netivism_custom_setting(&$form, &$form_state) {
